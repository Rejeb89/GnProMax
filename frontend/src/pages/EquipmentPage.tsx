      ...
      {showHandoverModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-md mx-4">
            <h2 className="text-xl font-bold text-gray-900 mb-4">{t('releaseEquipment')}</h2>
            ...
            <div className="space-y-4">
              <div>
                ...
                <select
                  value={handoverData.equipmentId}
                  onChange={(e) => setHandoverData({ ...handoverData, equipmentId: e.target.value })}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg text-right"
                >
                  <option value="">اختر التجهيز</option>
                  {equipment.map((item) => (
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setHandoverData({ ...handoverData, quantity: parseInt(e.target.value) || 0 })}
              ...
              <div>
                ...
                <input
                  type="text"
                  value={handoverData.recipientName}
                  onChange={(e) => setHandoverData({ ...handoverData, recipientName: e.target.value })}
